...
?>
<?php get_header(); ?>
		<?php if(BROWSER_SIZE != 'mobile' ) { ?>
			<img id="degrees-image" src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/photos/degree_pages/header-940.jpg" />

<?php $widget_id = 'side-widget'; include('includes/inc-widget-degree-finder.php'); } ?>
		<div id="content" role="main">
			<section id="degree-content">
...
if ( have_posts() ) while ( have_posts() ) : the_post(); $currentPost = $post->ID; ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<div class="entry-content">
					...
					<?php $widget_id = 'content-widget'; include('includes/inc-widget-degree-finder.php'); ?>
